...
UNAME := $(shell uname -s)
ifeq ($(UNAME),Linux)
    INCLUDE_CFLAGS += -Wno-error=format-security -D_GLIBCXX_USE_CXX11_ABI=1 # Required for compiling with gcc/glibc
    LDFLAGS += -lstdc++ # Prevents linker errors. Should be "LDFLAGS" instead on non-nix
endif
